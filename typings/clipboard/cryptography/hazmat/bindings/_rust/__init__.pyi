...
from cryptography.hazmat.primitives.asymmetric.types import CertificateIssuerPublicKeyTypes, CertificatePublicKeyTypes, PrivateKeyTypes
from cryptography.x509 import certificate_transparency

def load_pem_x509_certificate(data: bytes, backend: typing.Any = ...) -> x509.Certificate:
    ...

def load_der_x509_certificate(data: bytes, backend: typing.Any = ...) -> x509.Certificate:
    ...

def load_pem_x509_certificates(data: bytes) -> list[x509.Certificate]:
    ...

def load_pem_x509_crl(data: bytes, backend: typing.Any = ...) -> x509.CertificateRevocationList:
    ...

def load_der_x509_crl(data: bytes, backend: typing.Any = ...) -> x509.CertificateRevocationList:
    ...

def load_pem_x509_csr(data: bytes, backend: typing.Any = ...) -> x509.CertificateSigningRequest:
    ...

def load_der_x509_csr(data: bytes, backend: typing.Any = ...) -> x509.CertificateSigningRequest:
    ...
...
def create_x509_certificate(builder: x509.CertificateBuilder, private_key: PrivateKeyTypes, hash_algorithm: hashes.HashAlgorithm | None, rsa_padding: PKCS1v15 | PSS | None) -> x509.Certificate:
    ...

def create_x509_csr(builder: x509.CertificateSigningRequestBuilder, private_key: PrivateKeyTypes, hash_algorithm: hashes.HashAlgorithm | None, rsa_padding: PKCS1v15 | PSS | None) -> x509.CertificateSigningRequest:
    ...

def create_x509_crl(builder: x509.CertificateRevocationListBuilder, private_key: PrivateKeyTypes, hash_algorithm: hashes.HashAlgorithm | None, rsa_padding: PKCS1v15 | PSS | None) -> x509.CertificateRevocationList:
    ...
...
class Sct:
    ...
    @property
    def signature_algorithm(self) -> certificate_transparency.SignatureAlgorithm:
        ...
...
class Certificate:
    ...
    @property
    def signature_algorithm_parameters(self) -> None | PSS | PKCS1v15 | ECDSA:
        ...
...
class ClientVerifier:
    ...
    def verify(self, leaf: x509.Certificate, intermediates: list[x509.Certificate]) -> VerifiedClient:
        ...
...
class ServerVerifier:
    ...
    def verify(self, leaf: x509.Certificate, intermediates: list[x509.Certificate]) -> list[x509.Certificate]:
        ...
