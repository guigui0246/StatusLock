...
class _FragList:
    ...
    flist: list[bytes]
    def __init__(self, init: list[bytes] | None = ...) -> None:
        ...
...
def load_ssh_private_key(data: bytes, password: bytes | None, backend: typing.Any = ...) -> SSHPrivateKeyTypes:
...
def load_ssh_public_key(data: bytes, backend: typing.Any = ...) -> SSHPublicKeyTypes:
    ...
