...
import _imp
from typing import Any, Callable, Dict, Iterable, Iterator, Literal, Mapping, MutableSequence, NamedTuple, NoReturn, Protocol, TYPE_CHECKING, Tuple, TypeVar, Union, overload
...
from pip._vendor.packaging import markers as _packaging_markers, requirements as _packaging_requirements, utils as _packaging_utils, version as _packaging_version
...
class WorkingSet:
    ...
    @overload
    def resolve(self, requirements: Iterable[Requirement], env: Environment | None, installer: _InstallerTypeT[_DistributionT], replace_conflicting: bool = ..., extras: tuple[str, ...] | None = ...) -> list[_DistributionT]:
        ...
    ...
    def resolve(self, requirements: Iterable[Requirement], env: Environment | None = ..., installer: _InstallerType | None | _InstallerTypeT[_DistributionT] = ..., replace_conflicting: bool = ..., extras: tuple[str, ...] | None = ...) -> list[Distribution] | list[_DistributionT]:
    ...
    @overload
    def find_plugins(self, plugin_env: Environment, full_env: Environment | None, installer: _InstallerTypeT[_DistributionT], fallback: bool = ...) -> tuple[list[_DistributionT], dict[Distribution, Exception]]:
        ...
    ...
    def find_plugins(self, plugin_env: Environment, full_env: Environment | None = ..., installer: _InstallerType | None | _InstallerTypeT[_DistributionT] = ..., fallback: bool = ...) -> tuple[list[Distribution] | list[_DistributionT], dict[Distribution, Exception],]:
    ...
    def __getstate__(self): # -> tuple[list[str], dict[Any, Any] | Any, dict[Any, Any] | Any, dict[Any, Any] | Any, Any | list[Any]]:
        ...
...
class Environment:
    ...
    @overload
    def best_match(self, req: Requirement, working_set: WorkingSet, installer: _InstallerTypeT[_DistributionT], replace_conflicting: bool = ...) -> _DistributionT:
        ...
    ...
    def best_match(self, req: Requirement, working_set: WorkingSet, installer: _InstallerType | None | _InstallerTypeT[_DistributionT] = ..., replace_conflicting: bool = ...) -> Distribution | None:
    ...
    def obtain(self, requirement: Requirement, installer: Callable[[Requirement], None] | _InstallerType | None | _InstallerTypeT[_DistributionT] = ...) -> Distribution | None:
...
class ResourceManager:
    ...
    def resource_exists(self, package_or_requirement: _PkgReqType, resource_name: str): # -> bool | Any:
        """Does the named resource exist?"""
        ...
    
    def resource_isdir(self, package_or_requirement: _PkgReqType, resource_name: str): # -> bool | Any:
        """Is the named resource an existing directory?"""
        ...
    
    def resource_filename(self, package_or_requirement: _PkgReqType, resource_name: str): # -> str | Any:
    ...
    def resource_listdir(self, package_or_requirement: _PkgReqType, resource_name: str): # -> list[str] | Any:
...
class DefaultProvider(EggProvider):
    ...
    def get_resource_stream(self, manager: object, resource_name: str): # -> BufferedReader[_BufferedReaderStream]:
        ...
...
class NoDists:
    ...
    def __call__(self, fullpath): # -> Iterator[Never]:
        ...
