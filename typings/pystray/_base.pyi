...
class Icon:
    ...
    def __init__(self, name, icon=..., title=..., menu=..., **kwargs) -> None:
        ...
...
class MenuItem:
    ...
    """
    def __init__(self, text, action, checked=..., radio=..., default=..., visible=..., enabled=...) -> None:
        ...
    
    def __call__(self, icon): # -> Any | None:
        ...
    ...
    @property
    def radio(self): # -> object | Literal[False]:
...
class Menu:
    ...
    @property
    def items(self): # -> object | tuple[Any, ...] | tuple[Any]:
        """All menu items.
        """
        ...
